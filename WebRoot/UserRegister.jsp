...
<div class="limiter">
    <div class="container-login100" style="background-image: url('css/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <span id="tiShiSpan1" style="color: red;"></span>
            ...
            <div class="wrap-input100 validate-input" data-validate="请输入密码">
                ...
                <div class="wrap-input100 validate-input" data-validate="请输入姓名">
                    ...
                    <input id="userName" class="input100" type="text" placeholder="请输入姓名" >
                    <span class="focus-input100" data-symbol="&#xf190;" ></span>
                </div>

            <div class="text-right p-t-8 p-b-31">
                <a style="font-size: 15px" href="/goUserLoginRegister">已有账号?点击登录</a>
            </div>
            ...
            <div class="container-login100-form-btn">
                <div class="wrap-login100-form-btn">
                    ...
                    <button type="button" class="login100-form-btn" id="btn_register">注  册</button>
                </div>
            </div>
